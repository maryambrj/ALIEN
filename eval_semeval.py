...
def eval_relationship_extraction(agent_output_path, ground_truth_path):
    ...
    merged['pred_relation'] = merged['pred_relation'].fillna('Other')
    ...
    print("Category F1s (including 'Other'):")
    for label in all_labels:
...
if __name__ == "__main__":
    print(eval_relationship_extraction('relationships_semeval.csv', 'test_semeval_filtered.csv'))