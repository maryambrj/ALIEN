...
CHUNKS = 30  # Number of chunks; can make this a parameter as needed
#########################################################################################
...
reflection_prompt_template = [
    (
        ...
        "No more than one entity, target, and relationship and invert_relation per extraction per given story. Allow duplicates. Always provide detailed critique."
    ),
    (
        "system",
...
if __name__ == "__main__":
    ...
    df.to_csv('relationships_core_all25flash.csv', index=False)
